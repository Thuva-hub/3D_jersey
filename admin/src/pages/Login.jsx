                        ...
                        <div className="relative z-10 max-w-lg">
                            <div className="mb-8">
                                ...
                                <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6 leading-tight">
                                    Welcome to RealEstate.lk
                                </h2>
                            </div>

                            <div className="prose prose-lg text-gray-700 space-y-4">
                                <p className="text-lg leading-relaxed">
                                    At <span className="font-semibold text-blue-700">RealEstate.lk</span>, our mission is simple: to make property discovery
                                    and transactions effortless, transparent, and accessible to everyone.
                                </p>

                                <p className="leading-relaxed">
                                    Whether you're buying your first home, investing in real estate, or listing a property, we are
                                    here to support you with technology, expertise, and personalized service.
                                </p>

                                <p className="leading-relaxed">
                                    We're committed to delivering not just listings, but real value to our clients. Thank you for
                            ...
                            <div className="mt-8 p-6 bg-white/60 backdrop-blur-sm rounded-2xl border border-white/20">
                                <div className="flex items-center space-x-4">
                                    ...
                                    <div>
                                        <h3 className="font-semibold text-gray-900 text-sm">Properties Group</h3>
                                        <p className="text-xs text-gray-600">Call & WhatsApp: +94XX-XXXXXXX</p>
                                    </div>
                                </div>
                            </div>
                        </div>
